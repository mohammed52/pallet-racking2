...
export const CAT_DOORS_SUBTITLE =
	"(Single Doors, Double Doors, Multiple Locking options and accessories)";
...
export const FILES_UPLOAD_SUCCESSFUL = "FILES_UPLOAD_SUCCESSFUL";
